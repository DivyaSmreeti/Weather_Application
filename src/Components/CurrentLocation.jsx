  ...
  return (
    ...
    <div className="container wrap1">
      <div className="row row1">
        ...
        <h1 className="">{weatherData.name}, {weatherData.sys.country}</h1>
        ...
        {searchedWeatherData ? (
              <div className="search-details">
                <h2>
                  {searchedWeatherData.name}, {searchedWeatherData.sys.country}
                </h2>
                <span>
                  Temperature: {searchedWeatherData.main.temp} °C
                </span>
                <span>
